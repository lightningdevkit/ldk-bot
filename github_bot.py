...
MIN_PR_ID = { "lightningdevkit/rust-lightning": 3634, "lightningdevkit/ldk-node": 512, "lightningdevkit/ldk-server": 64, "lightningdevkit/vss-server": 49, "lightningdevkit/vss-client": 37, "lightningdevkit/ldk-sample": 140, "lightningdevkit/rapid-gossip-sync-server": 101, "lightningdevkit/ldk-bot": 6 }
NUM_REQUIRED_REVIEWS = { "lightningdevkit/rust-lightning": 2, "lightningdevkit/ldk-node": 1, "lightningdevkit/ldk-server": 1, "lightningdevkit/vss-server": 1, "lightningdevkit/vss-client": 1, "lightningdevkit/ldk-sample": 1, "lightningdevkit/rapid-gossip-sync-server": 1, "lightningdevkit/ldk-bot": 1 }
...
class GitHubBot:
	...
	def get_repo_collaborators(self, repo_name):
		...
		return ["jkczyz", "TheBlueMatt", "valentinewallace", "wpaulino", "joostjager", "tnull", "tankyleo"]
